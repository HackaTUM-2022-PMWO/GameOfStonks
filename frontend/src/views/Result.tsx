...
function Result() {
  ...
  let results = [
    { name: "Greta", coins: 2239 },
    { name: "Elon", coins: 1899 },
    {
      name: "FreshHermann",
      coins: 1820,
    },
    { name: "Spong", coins: 289 },
    { name: "Trump", coins: 50 },
  ];
    ...
    <div>
      {startAnimation ? (
        <div className="flex flex-col justify-center items-center h-screen">
          <iframe
            src="https://giphy.com/embed/QQ1K0jv4JyUR750vrr"
            width="480"
            height="480"
          ></iframe>
        </div>
          ...
          <div className="flex items-end justify-center min-h-[90vh]">
            <div className="grid items-end mx-5 grid-cols-3">
              <div className="flex flex-col content-center text-center gap-4">
                ...
                <div className="flex flex-col items-center gap-8 h-[70vh] bg-accent2 shadow-md drop-shadow-xl rounded">
              ...
              <div className="flex flex-col content-center text-center gap-4">
                ...
                <div className="flex flex-col items-center gap-8 h-[80vh] bg-accent2 shadow-md drop-shadow-xl rounded">
              ...
              <div className="flex flex-col content-center text-center gap-4">
                ...
                <div className="flex flex-col items-center gap-8 h-[60vh] bg-accent2 shadow-md drop-shadow-xl rounded">
