        ...
        <div className="flex flex-col min-h-screen mt-5 mx-5">
            <div className="mx-10">
                ...
                <div className="relative">
                    ...
                    <button type="submit"
                            className="text-primary absolute right-2.5 bottom-2.5 bg-accent2 focus:ring-4 focus:outline-none hover:font-semibold focus:ring-purple-300 font-medium rounded-lg text-sm px-4 py-2 ">Search
                    </button>
                </div>
            </form>
            </div>
