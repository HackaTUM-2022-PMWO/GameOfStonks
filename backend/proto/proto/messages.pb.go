...
func (x *Stonk) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Stonk) ProtoMessage() {}

func (x *Stonk) ProtoReflect() protoreflect.Message {
	mi := &file_proto_messages_proto_msgTypes[0]
...
func (x *StonkRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StonkRequest) ProtoMessage() {}

func (x *StonkRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_messages_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StonkRequest.ProtoReflect.Descriptor instead.
func (*StonkRequest) Descriptor() ([]byte, []int) {
	return file_proto_messages_proto_rawDescGZIP(), []int{1}
}

func (x *StonkRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_proto_messages_proto_rawDesc = []byte{
	...
	,
...
var file_proto_messages_proto_goTypes = []interface{}{
	(*Stonk)(nil),        // 0: Stonk
	(*StonkRequest)(nil), // 1: StonkRequest
}
var file_proto_messages_proto_depIdxs = []int32{
	1, // 0: StonkServer.GetStonkByName:input_type -> StonkRequest
	0, // 1: StonkServer.GetStonkByName:output_type -> Stonk
